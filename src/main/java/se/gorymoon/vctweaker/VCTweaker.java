...
import se.gorymoon.vctweaker.fuel.FuelHandler;
import se.gorymoon.vctweaker.tweaker.TweakerIntegration;


@Mod(modid = VCTweaker.MODID, version = VCTweaker.VERSION, dependencies = "required-after:crafttweaker;required-after:vc;after:jei;")
public class VCTweaker
{
    ...
    public static class Configs {
        ...
        @Comment({"If the item list is a whitelist the this needs to be true.", "If the item list is a blacklist this needs to be false"})
        @Name("Is Whitelist")
